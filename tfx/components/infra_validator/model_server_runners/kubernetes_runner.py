...
_MODEL_SERVER_PIPELINE_ROOT_VOLUME_NAME = 'pipeline-root'
...
class KubernetesRunner(base_runner.BaseModelServerRunner):
  ...
  def _BuildPodManifest(self) -> k8s_client.V1Pod:
    ...
    self._SetupVolumesIfNeeded(result)
  ...
  def _SetupVolumesIfNeeded(self, pod_manifest: k8s_client.V1Pod):
    ...
    pod_manifest.spec.volumes.append(
        k8s_client.V1Volume(
            name=_MODEL_SERVER_PIPELINE_ROOT_VOLUME_NAME,
